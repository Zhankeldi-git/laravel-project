<nav class="site-header sticky-top py-1">
  <div class="container d-flex flex-column flex-md-row justify-content-between">
    ...
    <a class="py-2 d-none d-md-inline-block" href="{{route('notes')}}">
Add a note</a>
    <a class="py-2 d-none d-md-inline-block" href="{{route('mynote')}}">My notes</a>
    <a class="py-2 d-none d-md-inline-block" href="{{route('contact')}}">Contacts</a>
    <a class="py-2 d-none d-md-inline-block" href="{{route('login')}}">log In
</a>
